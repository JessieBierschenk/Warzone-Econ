...
NL_lm_mod <- lm(Log_GDP ~ as.factor(year)+name+NLI+nl_sum_4+nl_median_4+Labor_index+tw_count+MBA_degree_index+Unemployment_benefits_index+Emigration_index+Mercedes_index+Washing_machine_index, data = all_data_FE)
tidy(NL_lm_mod)
```
